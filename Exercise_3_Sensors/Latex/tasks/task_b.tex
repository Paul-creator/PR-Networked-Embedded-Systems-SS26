...
1. \textit{Describe the necessary startup sequence (e.g., set CTRL\_REG1 (20h) to 0x81). What is the default value of CTRL\_REG1?}

2. \textit{Describe how the relative humidity is calculated (incl formula) and describe each parameter! Which registers are involved? Which parameters are constants? Which parameters change? Where do you find the values that are needed for your calculation?}
